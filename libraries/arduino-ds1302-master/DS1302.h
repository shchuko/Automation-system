...
class Time {
 public:
  ...
  //
  // Args:
  //   yr: year. Range: {00, ..., 99}. (for the 21th sentury)
  //   mon: month. Range: {1, ..., 12}.
  //   date: date (of the month). Range: {1, ..., 31}.
  //   hr: hour. Range: {0, ..., 23}.
  //   min: minutes. Range: {0, ..., 59}.
  //   sec: seconds. Range: {0, ..., 59}.
  //   day: day of the week. Monday is 1. Range: {1, ..., 7}.
  
  Time(uint8_t yr, uint8_t mon, uint8_t date,
...
class DS1302 {
 public:
  ...
  //
  // Args:
  //   _ce_pin: CE pin number
  //   _io_pin: IO pin number
  //   _sclk_pin: SCLK pin number
  DS1302(uint8_t _ce_pin, uint8_t _io_pin, uint8_t _sclk_pin);
